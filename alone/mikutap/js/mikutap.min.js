				...
				var d = function (a, e) {
						...
						function n() {
							...
							if (0 == o)
								for (var t = 0; t < h.rotation; t += 30)
									(e = ((s * t + l) * Math.PI) / 180), (n = Math.cos(e) * a), (e = Math.sin(e) * a), c.lineTo(n, e);
							else
					...
					f = function (a, e) {
						...
						var t = function (a) {
							...
							function n() {
								0 == c
									? ((c = 1), (r = { x: i.x, y: i.y }), TweenLite.to(r, h, { x: o.x, y: o.y, ease: Power1.easeOut, onUpdate: e, onComplete: n }))
									: (t.clear(), (t.visible = !1));
							}
							...
							var t = function (a) {
								function e() {
									l.beginFill(i),
										...
										(l.scale.x = 0),
										(l.scale.y = 0),
										TweenLite.to(l.scale, 0.7, { x: 1, y: 1, ease: Elastic.easeOut.config(1, 0.3), onComplete: n });
								}
								function n() {
						...
						function (a, e) {
							...
							this.play = function () {
								...
								(t = 0.8 * Math.random() + 0.4),
									...
									TweenLite.fromTo(r.scale, 0.9, { x: t, y: t }, { x: a, y: a, ease: Bounce.easeOut }),
									s.play(e, n);
							};
							var t = this,
								i = a;
							...
							var t = function (a) {
								function e() {
									...
									r.beginFill(l()),
										...
										(r.scale.x = 0),
										(r.scale.y = 0),
										TweenLite.to(r.scale, 0.5, { x: 1, y: 1, ease: Elastic.easeOut.config(1, 0.3), onComplete: n });
								}
								function n() {
									...
									(this.play = function (a, n) {
										(t = n),
											...
											TweenLite.fromTo(
												...
												{ rotation: 0, ease: Elastic.easeOut.config(1, 0.3), delay: a }
											);
						...
						function (a, e) {
							...
							var t = function (a) {
								function e() {
									...
									TweenLite.to(i.scale, 0.3, { x: 0, y: 0, ease: Power1.easeOut, onComplete: n, delay: 0.5 }),
										TweenLite.to(i, 0.3, { x: e, y: a, ease: Power2.easeOut, delay: 0.5 });
								}
								function n() {
									(i.visibloe = !1), t && t();
								}
						...
						function (a, e) {
							...
							(this.play = function () {
								...
								for (var t = 0; t <= i; t++) {
									var u;
									e
										? ((u = { x: t * a, y: M * Math.random() }), 0 == t && (u.x -= 10), t == i && (u.x += 10))
										: ((u = { y: t * a, x: w * Math.random() }), 0 == t && (u.y -= 10), t == i && (u.y += 10)),
										(d[t] = u);
								}
					...
					k = [
						function (a, e) {
							...
							this.play = function () {
								...
								var f = 0;
								a
									? ((f = M / e), (i.pos.b0 = { x: 0, y: 0 }), (i.pos.b1 = { x: 0, y: M }))
									: ((f = w / e), (i.pos.b0 = { x: 0, y: 0 }), (i.pos.b1 = { x: w, y: 0 })),
